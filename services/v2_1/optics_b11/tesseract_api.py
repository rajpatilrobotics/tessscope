"""Served JAX/Chromatix B11 optics with photon-matched training noise."""
...
class InputSchema(BaseModel):
    phase_parameters: Differentiable[Array[(11,), Float32]]
    object_batch: Array[(None, 256, 256), Float32]
    depths_um: Array[(None,), Float32]
...
def apply_jit(inputs: dict) -> dict:
    sensor = simulate_noisy_sensor_b11(
    ...
    return {
        "sensor": sensor,
        "phase_coefficients": phase_coefficients_b11(inputs["phase_parameters"]),
